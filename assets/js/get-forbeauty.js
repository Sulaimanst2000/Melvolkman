// get_product beauty
const getbeauty_product = JSON.parse(localStorage.getItem("beautyvalue"));
const showingbeautyData = document.querySelector(".show-data")
// mapping product ceramic
const gettingbeautyData = getbeauty_product.map((data) => {
    return `     
    <a href="#">   
    <div class="col-md-7 col-12"${data.id}>
                    <div class="product-picture">
                        ...
                        <div class="pic-2">
                            <img src=${data.img_2} alt="">
                            <img src=${data.img_3} alt="">
                        </div>
                        <div class="pic-4">
                            <img src=${data.img_4} alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-12">
                    <div class="product-details-heading">
                        <h2 class="product-heading">${data.fbtt}</h2>
                        <p class="product-details-price">$ ${data.fbprice} USD</p>
...
showingbeautyData.innerHTML= gettingbeautyData.join('')
