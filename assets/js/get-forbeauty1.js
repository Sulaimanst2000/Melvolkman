// get_product beauty
const getbeauty1_product = JSON.parse(localStorage.getItem("beauty1value"));
const showingbeauty1Data = document.querySelector(".show1-data")
// mapping product ceramic
const getting1beautyData = getbeauty1_product.map((data) => {
    return `        
    <a href="#">
    <div class="col-md-7 col-12"${data.id}>
                    <div class="product-picture">
                        <div class="pic-1">
                            <img src=${data.image_4} alt="">
                        </div>
                        <div class="pic-4">
                ...
                <div class="col-md-5 col-12">
                    <div class="product-details-heading">
                        <h2 class="product-heading">${data.title}</h2>
                        <p class="product-details-price">$ ${data.price} USD</p>
...
showingbeauty1Data.innerHTML= getting1beautyData.join('')